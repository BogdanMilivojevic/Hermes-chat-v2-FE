...
const Message = ({ message }) => {
  ...
  return (
    <div className={`message ${message.Messages.userId === currentUser.id && 'owner'}`}>
      <div className='message-info'>
        <img src={message.Messages.userId === currentUser.id ? currentUser.photoURL : data.conversation.Users.photoURL}/>
      </div>
      <div className='message-content'>
        <div className='message-output'>
          ...
          {message.Messages.body && <p>{message.Messages.body}</p>}
        </div>
